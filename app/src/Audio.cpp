...
string Audio::FaustState::GenerateModelInstrumentDsp(const string_view model_dsp, int num_excite_pos) {
    ...
    static const string
        t60Scale = "t60Scale = hslider(\"t60[tooltip: Resonance duration (s) of the lowest mode.]\",20,0,100,0.01) : ba.sAndH(gate);",
        t60Decay = "t60Decay = hslider(\"t60 Decay[tooltip: Decay of modes as a function of their frequency, in t60 units.\nAt 1, the t60 of the highest mode will be close to 0 seconds.]\",0.80,0,1,0.01) : ba.sAndH(gate);",
        t60Slope = "t60Slope = hslider(\"t60 Slope[tooltip: Power of the function used to compute the decay of modes t60 in function of their frequency.\nAt 1, decay is linear. At 2, decay slope has degree 2, etc.]\",2.5,1,6,0.01) : ba.sAndH(gate);",
